...
int main()
{
	...
	cout<<"========================================================"<<endl;
	std::cout << "Tiempo en paralelo " << std::chrono::duration_cast<std::chrono::milliseconds>(time).count() << " to run.\n";	
	cout<<"========================================================"<<endl;
	smooth.display();
	img.display();
...
// g++ convolution_parallel.cpp -lm -lpthread -lX11 -std=c++11 -fopenmp
// ./a.out